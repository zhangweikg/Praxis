...
<div class="login-container">
								...
								<div id="login-box" class="login-box widget-box no-border visible">
									<div class="widget-body">
										<div class="widget-main">
											...
											<form class="" name="form1" action="<%=path %>/LogServlet" method="post">
												<fieldset>
										<ul>
   <li class="frame_style form_error"><label class="user_icon"></label><input name="loginname" type="text"  id="loginname"/><i>用户名</i></li>
   <li class="frame_style form_error"><label class="password_icon"></label><input name="loginpwd" type="password"   id="loginpwd"/><i>密码</i></li>
   ...
   -->
                        ...
                        <!--<div class="loginbm">版权所有  2018  <a href="">南京思美软件系统有限公司</a> </div><strong></strong>-->
</body>
</html>
<script>
