...
<div class="clearfix">
     ...
     <div class="side_list">
      ...
      <div class="widget-body">
         <ul class="b_P_Sort_list">
             ...
             <li><i class="fa fa-newspaper-o pink "></i> <a href="#">企业文化</a></li>
             <li> <i class="fa fa-newspaper-o pink "></i> <a href="#">品质工程</a> </li>
             <li> <i class="fa fa-newspaper-o pink "></i> <a href="#">无忧服务</a></li>
         </ul>
  </div>
  </div>
  </div>  
 ...
 <div class="Ads_list">
  <!--  <div class="border clearfix">
       <span class="l_f">
        <a href="article_add.jsp"  title="添加文章" id="add_page" class="btn btn-warning"><i class="fa fa-plus"></i> 添加文章</a>
       ...
       <thead>
        ...
        <tbody>
         <tr>
          ...
          <td>显示</td>-->
          <td class="td-manage">
          	 <a href="article_update.jsp" id="news_update" class="btn btn-warning">修改</a>
