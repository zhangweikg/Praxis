 ...
 <div id="products_style">
    <div class="search_style">
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="product-add.jsp" title="添加商品" class="btn btn-warning Order_form">添加商品</a>
	...
	<tbody>
     ...
     <tr>
     <%-- <c:forEach var="gd" items="${ products}"> --%>
        <td width="25px"><label><input type="checkbox" class="ace" ><span class="lbl"></span></label></td>
        <td width="80px">XXX</td>               
        <td width="250px"><u style="cursor:pointer" class="text-primary" onclick="">XXX</u></td>
        <td width="100px">XXX</td>
        <td width="100px">XXX</td> 
        <td width="100px">2018-8-24 11:11:42</td>         
        <td width="180px">XXX</td>
        <td width="180px">XXX</td>
        <td width="180px">XXX</td>
       <!-- <td class="text-l">XXX</td>
        <td class="text-l">XXX</td>
        <td class="text-l">XXX</td>
        <td class="td-status"><span class="label label-success radius">XXX</span></td>-->
        <td class="td-manage">
