...
<div class="clearfix" id="add_picture" >
   ...
   <div class="type_title">添加在建工地</div>
	<form method="post" onsubmit="return SubmitCheck()" action="<%=request.getContextPath() %>/addBuildProductsServlet?" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add"> 
		<div class="clearfix cl">
		 ...
		 <div class="formControls col-10"><input type="text" onblur="nameValidate()" size="125" value="" placeholder="" id="name" name="name"> <span id="namee"> </span></div>
		</div>
		<div class=" clearfix cl">
         <label class="form-label col-2">产品介绍：</label>
	     <div class="formControls col-10"><input type="text" onblur="infoValidate()"  size="125" value="" placeholder="" id="info" name="info"><span id="infoo"> </span></div>
		</div>
		<div class=" clearfix cl">
			...
			<!--建筑面积-->
			 ...
			 <div class="formControls col-2"><span class="select-box">
				<select class="select" name="area" >
					<option value="1">100平米以下</option>
					<option value="2">101-200平米</option>
					<option value="3">201-300平米</option>
					<option value="4">300平米以上</option>
				</select>
				</span></div>
			</div>
			...
			<!--户型-->
			 ...
			 <div class="formControls col-2"><span class="select-box">
				...
				<%  ArrayList<BuildingType> types = (ArrayList) buildingTypeService.returnAllBuildingType();; %>
			...
			<div class="formControls col-2"><input type="text" onblur="cityValidate()" class="input-text" value="" placeholder="" id="city" name="city"><span id="cityy"> </span></div>
            </div>
      <br />
      <div class="clearfix cl">
			   <div align="left" style="padding-left: 30px;"><br><br><br><br><br>图片上传：</div>
