...
<div class="type_style" >
 <div class="type_title">产品类型信息</div>
  ...
  <!--<a href="javascript:ovid()" class="btn  btn-warning"><i class="icon-edit align-top bigger-125"></i>新增父类型</a>-->
  <a href="javascript:ovid()" class="btn  btn-success"><i class="icon-ok align-top bigger-125"></i>新增子类型</a>
     ...
     <div align="left">
			...
			分类名称：
				...
				<select class="select">
					...
					<option value="3">居住面积</option>
					<option value="4">建筑阶段</option>
				</select>
				</span></div>
			</div>
    </div>
