...
<div class="page-content clearfix">
 <div class="sort_style">
     <div class="border clearfix">
       <span class="l_f">
        <a href="news-add.jsp"  class="btn btn-warning">添加新闻</a>
  ...
  <div >
	...
	<tbody>
      ...
      <td  align="center">
        <a href="news_update.jsp" id="sort_update" class="btn btn-warning">修改</a>
...
<div class="sort_style_add margin" id="sort_style_add" style="display:none">
  <div class="">
     <ul>
      <li><label class="label_name">新闻标题</label><div class="col-sm-9"><input name="新闻标题" type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-5"></div></li>
      <li>
      	<label class="label_name">分类说明</label><div class="col-sm-9"><textarea name="分类说明" class="form-control" id="form-field-8" placeholder="" onkeyup="checkLength(this);"></textarea><span class="wordage">剩余字数：<span id="sy" style="color:Red;">200</span>字</span></div>
      </li>
