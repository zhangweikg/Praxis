...
<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
                     ...
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
						 ...
						 <li class="home"><a href="javascript:void(0)"  name="<%=request.getContextPath() %>/ProductsServlet?action=adminshowAllIsBuildingProducts" title="在建工地列表"  class="iframeurl"><i class="icon-double-angle-right"></i>在建工地列表</a></li>
						 <li class="home"><a href="javascript:void(0)" name="<%=request.getContextPath() %>/CategoryServlet?action=look" title="分类管理"  class="iframeurl"><i class="icon-double-angle-right"></i>分类管理</a></li>
						</ul>
					</li>
					<li>
					<a href="#" class="dropdown-toggle"><i class="icon-picture "></i><span class="menu-text"> 营销活动 </span><b class="arrow icon-angle-down"></b></a>
						...
						<li><a href="#" class="dropdown-toggle"><i class="icon-bookmark"></i><span class="menu-text"> 文章管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)" name="<%=request.getContextPath() %>/PassageServlet?action=find_all_passage" title="文章列表" class="iframeurl"><i class="icon-double-angle-right"></i>文章列表</a></li>
							</ul>
						</li>
					</ul>
					</div>
