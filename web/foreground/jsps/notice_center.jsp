<%@ page contentType="text/html;charset=UTF-8" import="java.util.*"
  import="com.software.domain.Announcement" language="java" %>
 <%  
...
(function() {
  ...
  s.parentNode.insertBefore(hm, s);
    ...
    <script type="text/javascript" src="<%=basePath%>js/YMDClass.js" tppabs="http://www.xydec.com.cn/js/js/YMDClass.js"></script>
        ...
        <div class="wrap clearfix">
            <div class="logo">
                <a href="../../index.jsp" tppabs="http://www.xydec.com.cn/Default.aspx">
                    <img alt="" class="lazyload" data-original="upload/1702/img/201702230818558672167.png" src="<%=basePath%>img/201702230818558672167.png" tppabs="http://www.xydec.com.cn/upload/1702/img/201702230818558672167.png" /></a>
            </div>
        ...
        <div class="sub-banner">
            <div class="bd">
                <ul>
                    ...
                    <li style="background-image: url(<%=basePath%>img/201802071702436308751.jpg);"><a target="_blank" tppabs="http://www.xydec.com.cn/xydai.aspx"></a></li>
            ...
            <div class="wrap">
                ...
                <input type="hidden" name="action" value="search">
                    ...
                    <div class="fr">
                        ...
                        <input type="submit" value=" " id="btnkeyword" />
                    </div>
                </form>
            </div>
        </div>
                ...
                <ul>
                        ...
                        <div class="fr">
                            ...
                            <h5><a target="_blank"  tppabs="http://www.xydec.com.cn/MarketingDel.aspx?m_id=4239">
                            	<%
                            	String str=list.get(i).getNotice_content();
                            	String str1=str.substring(0,140)+"...";
                            	out.print(str1);
                            	%></a></h5>
                            <p>
                                <span>
                                    <span><font>发布时间：</font><%=list.get(i).getNotice_publish_time() %></span>
                                </span>
                            </p>
                            <h6 class="clearfix">
                                <div id="win<%=i%>" style="display:none; position:fixed; left:300px; top:100px; width:780px; height:456px; border:1px solid #aaa; background-color:#eee">
	                            <h2 style="position:absolute; left:0; top:0; width:100%; height:30px; line-height:30px; font-size:16px; margin:0; text-indent:10px; color:#666; background-color:#ddd"><%=list.get(i).getNotice_title() %></h2>
	                            <span style="position:absolute; right:4px; top:4px; color:#aaa; cursor:pointer" onclick="win<%=i%>.style.display='none';">×</span>
	                            <div style="margin-top:30px; padding:10px; color:#888">
	                            <font size="3"><%=list.get(i).getNotice_content() %></font></div>
                            </div>
                                <button onclick="win<%=i%>.style.display='block';"><font size="4">查看详情</font></button>
                            </h6>
